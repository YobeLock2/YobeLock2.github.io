...
export function HeaderAuth() {
    ...
    <header>
        <div className="container">
            ...
            <div className={burgerActive ? "transparent_bg active" : "transparent_bg"} onClick={() => setBurgerActive(false)}></div>
            ...
            <div className={burgerActive ? "site_header active" : "site_header"} onClick={() => setBurgerActive(false)}>
                <div className="left_section">
                    ...
                    <button onclick="location.href='https://t.me/YourBot';">Telegram Bot</button>
                </div>
                <div className="right_section">
                    <button onClick={() => openModal('login')} className="login_btn">Вход</button>
                    <button onClick={() => openModal('singup')} className="reg_btn">Регистрация</button>
                </div>
            </div>
        </div>
    </header>
